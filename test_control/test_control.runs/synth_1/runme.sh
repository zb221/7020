...
HD_PWD='E:/zhuobin/backup/test_control/test_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_control_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_control_wrapper.tcl
