...
HD_PWD='E:/firmware/XILINX/demo/test_control/test_control.runs/main_control_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_control_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_control_rst_ps7_0_50M_0.tcl
