...
HD_PWD='E:/zhuobin/backup/test_control/test_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_control_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_control_wrapper.tcl -notrace
