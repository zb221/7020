...
ISEStep( "vivado",
         "-log main_control_axis_register_slice_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_control_axis_register_slice_0_0.tcl" );
