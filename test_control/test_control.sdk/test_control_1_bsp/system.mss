...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = RCLEAR
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = VGCLK
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = VGDATEN
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = VGSDATA
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad9226_sample
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ad9226_sample_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = freq_out
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = freq_out_0
END
